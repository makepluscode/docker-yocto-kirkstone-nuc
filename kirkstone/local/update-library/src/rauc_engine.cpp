...
void RaucEngine::onProgressUpdate(int percentage, const char* message, void* user_data) {
...
void RaucEngine::onInstallCompleted(int result, const char* message, void* user_data) {
    RaucEngine* engine = static_cast<RaucEngine*>(user_data);
    if (!engine) return;
