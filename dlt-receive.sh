#!/usr/bin/env bash
# dlt-receive.sh – Convenience wrapper to stream DLT logs
# Usage:
#   ./dlt-receive.sh <NUC_IP> [PORT] [EXTRA_DLT_OPTIONS]
# Example:
#   ./dlt-receive.sh 192.168.0.50               # default port 3490
#   ./dlt-receive.sh 192.168.0.50 3491 -e DBO   # custom port + filter
#
set -e
...
echo "📡 Connecting to $NUC_IP:$PORT ..."
